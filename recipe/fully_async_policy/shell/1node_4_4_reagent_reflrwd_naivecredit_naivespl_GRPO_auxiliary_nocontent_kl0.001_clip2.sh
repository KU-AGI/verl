...
exp_name='reagent_reflrwd_naivecredit_naivespl_GRPO_auxiliary_nocontent_kl0.001_clip2'
...
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/data/chem_dapo/syntheticreact_auxiliary_reagent_train.parquet"}
