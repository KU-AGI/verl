...
exp_name='0105_rollout_freeze_dump'
...
TRAIN_FILES=/data/mllm/data/train_0k_5k_freeze_nipa.parquet
VAL_FILES=/data/mllm/data/val_0k_5k_freeze_nipa.parquet
...
trigger_parameter_sync_step=10000
require_batches=1
...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    +trainer.save_to_arrow=True \
    +trainer.arrow_buffer_size=1024 \
    +trainer.arrow_output_dir="$CKPTS_DIR/freeze_dump" \