...
exp_name='reagent_steprwd_naivecredit_naivespl_GRPO_3to720kallfalut10k_nodecisionrwd'
...
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/data/chem_dapo/syntheticreact_extra_3to7_20k_allfalut_10k_reagent_samples_for_train.parquet"}
