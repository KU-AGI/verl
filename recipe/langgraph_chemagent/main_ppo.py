...
from recipe.langgraph_chemagent.ray_trainer import RayPPOTrainer # Customized PPO trainer
...
class TaskRunner:
    ...
    def add_actor_rollout_worker(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}:
            from recipe.langgraph_chemagent.workers.fsdp_workers import AsyncActorRolloutRefWorker

            actor_rollout_cls = AsyncActorRolloutRefWorker
            ray_worker_group_cls = RayWorkerGroup

        elif config.actor_rollout_ref.actor.strategy == "megatron":
            from recipe.langgraph_chemagent.workers.megatron_workers import AsyncActorRolloutRefWorker
