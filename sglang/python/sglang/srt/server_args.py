...
class ServerArgs:
    ...
    enable_janus_image_cuda_graph: bool = False
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            action="store_true",
            help=(
                "Capture and use a Janus-Pro image-generation CUDA graph. "
                "Only enable this when Janus image-generation requests are not "
                "mixed with text/image-understanding requests in the same decode batch."
            ),
        )
        parser.add_argument(
