...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_path", default="/home/work/AGILAB/mllm_reasoning/data/ourdataset/train/rl_prompt/v5/final_train/train_filtered_wo_focusdiff_aug_106611.json")
    ...
    train_save_path = os.path.join(args.save_dir, "train_v5_wo_focusdiff_aug.parquet")
