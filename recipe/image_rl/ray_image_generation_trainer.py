...
class RayImageGenerationTrainer(RayPPOTrainer):
    ...
    def _write_detailed_report(self, rollout_dir, i, item, paths, prompt, feedback_texts, scores, 
        ...
        with open(txt_path, 'w', encoding='utf-8') as f:
            ...
            f.write(f"  - VQA Pass(1) or Fail(0): {self._get_safe_val(reward_extra_infos_dict, 'task2_vqa_pass_or_fail_reward', i)}\n")
            ...
            f.write(f"  - VQA Pass(1) or Fail(0) Response: {self._get_safe_response(reward_extra_infos_dict, 'task2_vqa_pass_or_fail_reward_response', i)}\n")
