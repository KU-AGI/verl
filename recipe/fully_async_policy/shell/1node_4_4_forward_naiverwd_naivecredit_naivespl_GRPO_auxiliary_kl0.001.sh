...
exp_name='forward_naiverwd_naivecredit_naivespl_GRPO_auxiliary_kl0.001'
...
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/data/chem_dapo/syntheticreact_remained_forward_samples_for_train_fixed.parquet"}
