...
def compute_reward_async(data: DataProto, config=None, tokenizer=None, processor=None, reward_fn=None, eval=False, task_id=None):
    """
    ...
    return compute_reward(data, reward_fn, eval, task_id)
