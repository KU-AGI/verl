#!/usr/bin/env bash
#SBATCH --job-name=rl-chemistry-agent
...
model_path=$DATA_ROOT/models/Qwen3-4B # Qwen3-4B # Qwen3-8B # Qwen3.5-4B
if [ ! -d "$model_path" ]; then
  model_path=Qwen/Qwen3-4B # Qwen3-4B # Qwen3-8B # Qwen3.5-4B
fi
...
experiment_name=chemistry_agent_qwen3_4B
...
python3 -m recipe.langgraph_chemagent.main_ppo \
    ...
    actor_rollout_ref.rollout.enable_think=true \
