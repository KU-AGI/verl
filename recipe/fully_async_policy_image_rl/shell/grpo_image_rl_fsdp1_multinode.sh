...
exp_name="0324_KT_our_model_our_dataset_total_step_fine_grained_reward_replay_buffer_mean_std_filtering_v3"
task_ids='[1,2,3]'
...
replay_buffer_filter_mode=mean_std_constant      # "mean", "std", or "max"
